...
func NewUserAgentsHandler(userService services.IUserService, heartbeatsService services.IHeartbeatService, teamService services.ITeamService) *UserAgentsHandler {
