...
func GetMigrationFunc(cfg *config.Config) GormMigrationFunc {
	...
	default:
		return func(db *gorm.DB) error {
			...
			if err := db.AutoMigrate(&models.Team{}); err != nil && !cfg.Db.AutoMigrateFailSilently {
				return err
			}
			if err := db.AutoMigrate(&models.TeamMember{}); err != nil && !cfg.Db.AutoMigrateFailSilently {
				return err
			}
			...
			if err := db.AutoMigrate(&models.MonitoredSite{}); err != nil && !cfg.Db.AutoMigrateFailSilently {
				return err
			}
			return nil
		}
